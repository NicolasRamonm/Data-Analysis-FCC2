...
def calculate_demographic_data(print_data=True):
    ...
    country_salary_percentage = df[df['salary'] == '>50K'].groupby('native-country')['salary'].count() / df.groupby('native-country')['salary'].count()
    highest_earning_country = country_salary_percentage.idxmax()
    highest_earning_country_percentage = round(100 * country_salary_percentage.max(), 1)
